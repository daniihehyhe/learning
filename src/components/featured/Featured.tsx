...
function Featured() {
  ...
  return (
    <div>
      <div className="text-black text-[32px] font-bold mt-20 text-center md:text-left">
        Featured Courses
      </div>
      <div className="flex items-center justify-between flex-col md:flex-row">
        <div className="text-[#637381] mt-2 font-regular text-center text-[16px]">
            ...
            <div className="mx-auto">
              <div className="shadow-sliderShadow rounded-[16px] w-[335px] h-[703px]">
                ...
                <div className="flex justify-between items-center px-8 my-8">
                  <div className="font-semibold text-orange text-[12px] uppercase">
                    Management
                  </div>
                  <div className="font-bold text-[24px] ">${item.price}</div>
                </div>
                <div className="font-semibold text-black text-[18px] px-8">
                  {item.title}
                </div>
                <div className="flex px-8 mt-4 items-center">
                  <img src={star} alt="Star" />
                  <div className="text-black font-semibold text-[18px] ml-2">
                    4.8{" "}
                    <span className="text-[#637381] text-[14px] font-regular">
                      {" "}
                      (1.089)
                    </span>
                  </div>
                  ...
                  <div className="font-semibold text-black text-[14px]">
                    180k <span className="font-regular">students</span>
                  </div>
                </div>
                ...
                <div className="flex pl-6 gap-4 items-end">
                  ...
                  <div className="text-[#919EAB] text-[14px] font-regular">
                    100 hours
                  </div>
