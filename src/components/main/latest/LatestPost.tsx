                    ...
                    <div key={item.title} className="flex mt-5 gap-5 sm:flex-col sm:w-[362px] sm:border-[1px] sm:rounded-[10px] sm:border-solid sm:border-[#919EAB3D]">
                        ...
                        <div className="sm:p-[24px] flex gap-5">
                            <div className="flex flex-col gap-3">
                                <div className="hidden sm:block text-[14px] font-semibold text-[#212B36] mx-auto dark:text-white">{item.month}</div>
                                <hr className="hidden sm:block dark:text-white"/>
                                <div className="hidden sm:block text-[#212B36] text-[30px] font-bold dark:text-white">{item.day}</div>
                            </div>
                            <div>
                                <div className="text-[19px] text-[#212B36] font-semibold leading-[26px] dark:text-white">{item.title}</div>
                                <div className="hidden sm:block text-[#637381] text-[14px] font-regular sm:mt-[8px] dark:text-[#919EAB]">Moment in the life of any aspiring astronomer of that it is time to.</div>
                                <div className="sm:mt-[23px] flex gap-3">
                                    ...
                                    <div className="flex items-center gap-2 sm:flex-col sm:gap-0 sm:items-start">
                                        <div className="hidden sm:block text-[#212B36] text-[14px] font-regular dark:text-white">{item.name}</div>
