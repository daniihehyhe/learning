...
function FeaturedCategory() {
  return (
    <div className='px-[20px] py-[80px] bg-[#F9FAFB] sm:px-[60px] lg:px-[144px] lg:py-[120px] dark:bg-[#919EAB1F]' >
        <div className='lg:flex lg:justify-between lg:items-start lg: gap-[100px]'>
            <div className='lg:w-[368px]'>
                <div className='text-black text-[32px] font-bold text-center lg:text-left dark:text-white'>Featured Category</div>
            ...
            <div className='mt-[64px] flex flex-wrap justify-between gap-[16px] lg:w-[662px] lg:justify-center lg:mt-0'> 
                {
                    categoryData.map((item,index) => (
                        <div key={index} className='w-[155px] h-[130px] rounded-[12px] bg-white border-solid border-[1px] border-[#919EAB3D] lg:hover:text-[#FA541C] cursor-pointer p-[24px]  lg:w-[205px] lg:h-[108px] lg:bg-[#F9FAFB] lg:hover:bg-white lg:hover:shadow-category dark:bg-[#919EAB1F] dark:hover:bg-[#212B36] dark:hover:border-none dark:hover:shadow-none'>
                            <div className='text-black text-[14px] font-semibold lg:hover:text-[#FA541C] dark:text-white'>{item.title}</div>
                            <div className='text-[#637381] text-[13px] font-regular mt-[4px] dark:text-[#919EAB]'> {item.subtitle}</div>
                        </div> 
                    ))
                }
            </div>
